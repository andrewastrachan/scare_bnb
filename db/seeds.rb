...
users = User.create!([{name: 'Patrick', email: 'patrickbateman2014rd@outlook.com', password: "password", gravatar_url: "http://apocalypstick.com/wp-content/uploads/2013/04/patrick-bateman.gif"},
